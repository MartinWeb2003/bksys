...
import { getCampProfile, getKeyGrid, listBookings, listNotes, listParcels, listParcelTypes } from "@/lib/data";
...
export default async function Page() {
  ...
  const [bookings, parcels, types, notes, keyGrid] = await Promise.all([
    listBookings(campId),
    listParcels(campId),
